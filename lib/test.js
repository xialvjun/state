...
var AuthState = /** @class */ (function (_super) {
    ...
    function AuthState() {
        ...
        _this.state = { logined: false };
        _this.other_property = 123;
        return _this;
    }
...
var unsubscribe = auth.onChange(function () {
    console.log(auth.state);
});
auth.login("xialvjun", "password");
var on_other_event = function () {
...
unsubscribe();
var counter_state = new index_1.State({ count: 0 });
var counter = counter_state;
counter.inc = function () { return counter.setState({ count: counter.state.count + 1 }); };
counter.dec = function () { return counter.setState({ count: counter.state.count - 1 }); };
